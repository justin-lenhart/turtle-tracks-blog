---
title: "Grapevine & Breadbox Update"
date: 2026-09-20
summary: "A cherry-and-maple bread box with box-joint corners, a bevel-front lid, a plexiglass door, and a cutting board that slides out of the side. four months, two versions, one recipient. Also, I went to the Grapevine wine festival"
...
{{< gallery >}}
  <img src="grapevine-1.jpeg" class="grid-w33" />
  <img src="grapevine-2.jpeg" class="grid-w33" />
  <img src="grapevine-3.jpeg" class="grid-w33" />
{{< /gallery >}}
...
{{< stats columns="4" >}}
  {{< stat value="15½ × 9¾ × 12½" label="Finished size" >}}inches, W × D × H{{< /stat >}}
  {{< stat value="29" label="Box joint fingers" >}}18 side-to-bottom, 11 side-to-top{{< /stat >}}
  {{< stat value="50.5°" label="Front bevel" >}}cut before glue-up, pieces taped in pairs{{< /stat >}}
  {{< stat value="2" label="Versions" >}}one abandoned, one finished{{< /stat >}}
{{< /stats >}}
...
![Rough cut plan](BreadBoxV0.2_Rough_Cuts_02.jpeg "A02 — three boards, every part nested, offcuts in pink")
